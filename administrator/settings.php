                                ...
                                <div class="alert bg-sidebar">
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-sm-12">
                                                <form id="form-account-image" class="text-center">
                                                    <figure>
                                                        <input type="hidden" class="form-control current-id" name="image_id">
                                    ...
                                    <form id="form-account-info">
                                        <div class="row mb-3 h5">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input group">
                                                    <input type="hidden" class="form-control current-id" name="account_id">
                                        ...
                                        <div class="row mb-2 h5">
                                            ...
                                            <div class="col-sm-9">
                                                <input disabled type="text" class="form-control-plaintext" placeholder="User Level" id="account-info-userlevel">
                                            </div>
                                        </div>
                                        <div class="row mb-2 h5">
                                            <label class="col-sm-3 col-form-label text-truncate">Status</label>
                                            <div class="col-sm-9">
                                                <input disabled type="text" class="form-control-plaintext" placeholder="Status" id="account-info-status">
                                            </div>
                                        </div>
                                        <div class="row mb-2 h5">
                                            <label class="col-sm-3 col-form-label text-truncate">Generated</label>
                                            <div class="col-sm-9">
                                                <input disabled type="text" class="form-control-plaintext" placeholder="Date/Time" id="account-info-datetime">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                            ...
                                            <form id="form-personal-info">
                                                <div class="row mb-3 text-truncate">
                                                    <div class="fw-bolder text-uppercase">Personal Information
                                                        ...
                                                        <input type="hidden" class="form-control current-id" name="personal_id">
                                                    </div>
                                                </div>
                                                <div class="row mb-3 h5">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <div class="input-group d-none account-info-div">
                                                            ...
                                                            <span class="position-absolute valid-feedback" id="valid-firstname" style="font-size: 13px"></span>
                                                            <span class="position-absolute invalid-feedback" id="invalid-firstname" style="font-size: 13px"></span>

                                                            <input disabled type="text" class="form-control account-info-002" placeholder="Last Name" name="lastname" id="account-lastname">
                                                            <span class="position-absolute valid-feedback" id="valid-lastname" style="font-size: 13px"></span>
                                                            <span class="position-absolute invalid-feedback" id="invalid-lastname" style="font-size: 13px"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mb-3 h5">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group">
                                                            ...
                                                            <span class="position-absolute valid-feedback" id="valid-email" style="font-size: 13px"></span>
                                                            <span class="position-absolute invalid-feedback" id="invalid-email" style="font-size: 13px"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mb-3 h5">

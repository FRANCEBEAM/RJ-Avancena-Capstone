...
<html lang="en">
                ...
                <div class="row mb-2">
                    <div class="col-sm-8 col-md-8 col-lg-6 text-truncate">
                        <div class="fs-2 fw-bolder text-uppercase" id="title">
                            <span class="text-muted me-2">|</span><span>Online Orders</span>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6 fs-2 align-self-center mb-2">
    ...
    <script src="/assets/js/online-orders.js"></script>
    </body>
</html>